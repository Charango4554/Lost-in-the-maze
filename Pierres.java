...
public class Pierres extends Case
{
    ...
    /**
     * Constructeur de la classe Pierres
     * @param plateau
     * @param lig
     * @param col
     */
    ...
    {        
        /* à son arrivée, le joueur est placé dans la case et récupère la pierre qu'elle contient */
    ...
    /**
     *Méthode appelée lorsqu'un joueur arrive sur une case de pierres
     * @param j
     * @param d
     */
    @Override
