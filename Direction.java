...
package exploration;
/*
    contient des méthodes statiques pour générer une direction aléatoire ou pour
    demander au joueur de saisir une direction. La classe contient également des 
    méthodes pour accéder et modifier les coordonnées de la direction et pour obtenir
    le symbole associé à la direction.
    */
