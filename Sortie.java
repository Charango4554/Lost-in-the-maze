...
public class Sortie extends Case {
    ...
    {
        /* ajout de code */
        System.out.println("la pierre a atteind la sortie");// Affiche un message dans la console pour indiquer que la pierre a atteint la sortie du plateau
        j.decNbPierres();// Appelle la
    } 
